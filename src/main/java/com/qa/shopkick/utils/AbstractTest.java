...
public class AbstractTest {
    final private static org.apache.log4j.Logger log = Logger.getLogger(AbstractTest.class);
    ...
    public static void createEnvironment() {
        ...
        createAndroidAppDriver();
    }

    public static AppiumDriver createAndroidAppDriver() {
